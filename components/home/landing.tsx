          ...
          <div className="col-span-12 md:col-span-7 lg:col-span-6 flex flex-col justify-center items-center">
            ...
            <div className="items-center w-3/4 -mt-10 relative">
              ...
              <h5 className="text-7xl font-light text-violet text-justify">
                I am a Full Stack Web and App Developer with a passion for solving complex problems.
                I specialize in creating robust, user-friendly applications and leveraging my
                expertise to deliver efficient and innovative solutions.
              </h5>
